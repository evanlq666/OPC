...
```bash
# 文生图（2K 自动比例）
node ~/.workbuddy/skills/jimeng-image-gen/scripts/jimeng.mjs generate --prompt "赛博朋克城市夜景，霓虹灯，雨天"

# 指定比例
node ~/.workbuddy/skills/jimeng-image-gen/scripts/jimeng.mjs generate --prompt "山水画，中国风" --ratio 16:9

# 4K 高清
node ~/.workbuddy/skills/jimeng-image-gen/scripts/jimeng.mjs generate --prompt "星空下的雪山" --ratio 16:9-4k --save ./output.png

# 字体设计模式
node ~/.workbuddy/skills/jimeng-image-gen/scripts/jimeng.mjs generate --text "618大促" --color 橙色 --illustration "购物车,礼盒,星星" --ratio 4:3

# 图生图（换背景）
node ~/.workbuddy/skills/jimeng-image-gen/scripts/jimeng.mjs generate --prompt "把背景换成星空" --image-url "https://..." --scale 0.7

# 强制单图（快速省钱）
node ~/.workbuddy/skills/jimeng-image-gen/scripts/jimeng.mjs generate --prompt "一只猫" --force-single --save ./cat.png

# 查看比例预设
node ~/.workbuddy/skills/jimeng-image-gen/scripts/jimeng.mjs ratios
```
