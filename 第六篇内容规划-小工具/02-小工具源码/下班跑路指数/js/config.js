...
window.CONFIG = {
  ...
  LEVEL_COLORS: {
    HIDDEN_TOP: '#FFC300',  // 隐藏款·下班跑路的神（鎏金，比 Lv8 更亮）
    L8: '#F5B301',          // Lv8 烫金
    L7: '#FFB020',          // Lv7 琥珀金
    L6: '#FF8C42',          // Lv6 琥珀橙
    L5: '#FF7A5C',          // Lv5 珊瑚橙
  ...
  // Canvas 结果卡：紧凑竖卡，按屏宽自适应 + dpr 高清
  CANVAS: {
    ratio: 4 / 3,           // 高宽比（3:4 竖屏），更适合结果卡截图
    margin: 28,             // 卡片距屏幕两侧边距（逻辑 px）
    minWidth: 280,
    maxWidth: 334,
